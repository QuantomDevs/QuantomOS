...
import { IframeWidget } from '../../base-items/widgets/IframeWidget';
...
export const SortableIframeWidget: React.FC<Props> = ({ id, editMode, isOverlay = false, onDelete, onEdit, onDuplicate, config }) => {
