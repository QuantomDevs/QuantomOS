...
import { CustomExtensionWidget } from '../../base-items/widgets/CustomExtensionWidget';
...
export const SortableCustomExtension: React.FC<Props> = ({
    id,
    editMode = false,
    isOverlay = false,
    onDelete,
    ...
    return (
        ...
        >
            <WidgetContainer editMode={editMode} id={id} onDelete={onDelete} onEdit={onEdit} onDuplicate={onDuplicate}>
                <CustomExtensionWidget config={config} />
            </WidgetContainer>
        </Grid2>
    );
};
